...
import java.io.*;
class MainProgram4//룰렛 휠, 피트니스는 440 에서 4곱해서 빼주기.
{
	...
	public static int makingChild(int[][] parent, int[] fitness, Grade[][] kmla, Teacher[] teacher, int mutationppercentage, int[] fatherGene){
